...
struct ShortcutsSheet: View {
    ...
    private let shortcuts: [(String, String)] = [
        ...
        ("New folder", "⇧⌘N"), ("Open…", "⌘O"), ("Properties", "⌘I"),
        ("Copy / Cut / Paste", "⌘C / ⌘X / ⌘V"), ("Select all", "⌘A"),
        ("Undo / Redo", "⌘Z / ⇧⌘Z"), ("Rename", "F2"),
        ("Move to Recycle Bin", "⇧⌫ or fn⌫"), ("Go up (parent folder)", "Backspace or ⌥↑"),
        ("Back / Forward", "⌥← / ⌥→"), ("Refresh", "F5 or ⌘R"),
        ...
        ("Open file / folder", "Enter"), ("Select next / previous", "↑ / ↓"),
